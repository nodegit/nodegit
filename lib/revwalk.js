...
var _fileHistoryWalk = Revwalk.prototype.fileHistoryWalk;
 ...
 */
Revwalk.prototype.fileHistoryWalk = function(filePath, maxCount) {
  var repo = this.repo;
  return _fileHistoryWalk(filePath, maxCount)
    .then(function(historyEntries) {
      return historyEntries.map(function(historyEntry) {
        historyEntry.commit.repo = repo;
        return historyEntry;
      });
    });
};
