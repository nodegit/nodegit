...
Repo.prototype.getCommit = function(oid, callback) {
  var self = this;
  oldGetCommit.call(this, util.normalizeOid(oid), function(error, commit) {
    if (error) return callback(error);
    commit.repo = self;
    callback(null, commit);
  });
...
Repo.prototype.getBlob = function(oid, callback) {
  var self = this;
  oldBlob.call(this, util.normalizeOid(oid), function(error, blob) {
    if (error) return callback(error);
    blob.repo = self;
    callback(null, blob);
  });
...
Repo.prototype.getTree = function(oid, callback) {
  var self = this;
  oldGetTree.call(this, util.normalizeOid(oid), function(error, tree) {
    if (error) return callback(error);
    tree.repo = self;
    callback(null, tree);
  });
...
Repo.prototype.getTag = function(oid, callback) {
  var self = this;
  oldGetTag.call(this, util.normalizeOid(oid), callback);
};
