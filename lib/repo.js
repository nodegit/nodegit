...
var Repo = exports.Repo = function(repo_path) {
  ...
  console.log('Opened ' + repo_path + ' Result: ' + ret);
...
Repo.prototype.lookup = function(arg) {
  ...
  if(arg instanceof String || typeof arg == "string") {
    ...
    if(arg == tmp) {
      console.log("OID Roundtrip'd")
    } else {
      console.log()
      console.log()
      console.log()
      console.log("OID Failed roundtrip: "+ arg +" != "+tmp)
      console.log()
    }
