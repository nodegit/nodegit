...
var initExt = Repository.prototype.initExt;
...
Repository.prototype.initExt = function(path, options) {
  if (options) {
    options = normalizeOptions(options, NodeGit.RepositoryInitOptions);
  }

  return initExt.call(this, path, options);
};
