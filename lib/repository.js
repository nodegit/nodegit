 ...
 */
Repository.prototype.stageFilemode = function(filePath, stageNew, newFilemode) {
  var repo = this;
  var index;
  ...
  return fse.remove(indexLock)
    ...
    .then(function(patches) {
      ...
      entry.mode = newFilemode ? newFilemode :
       stageNew ? pathPatch[0].oldFile().mode() : pathPatch[0].newFile().mode();
