...
DiffList.treeToTree = function(repo, oldTree, newTree, callback) {
  git.raw.DiffList.treeToTree(repo.rawRepo, oldTree.rawTree, newTree.rawTree, null, function(error, rawDiffList) {
