...
if (Worker) {
  describe("Worker", function () {
    ...
    afterEach(function () {
      return NodeGit.FilterRegistry.unregister(filterName).catch(function (error) {
    ...
    it("can kill worker thread while doing a checkout and exit gracefully", function (done) {
      // jshint ignore:line
    ...
    it("can track objects to free on context shutdown after multiple checkouts", function (done) {
      // jshint ignore:line
      let testOk;
