...
describe("Patch", function () {
  ...
  it("can generate patch from blobs", function () {
    ...
    return NodeGit.Blob.lookup(this.repository, "b252f396b17661462372f78b7bcfc403b8731aaa").then((blob) => {
      return NodeGit.Blob.lookup(this.repository, "b8d014998072c3f9e4b7eba8486011e80d8de98a").then((oldBlob) => {
        return NodeGit.Patch.fromBlobs(oldBlob, file, blob, file).then((patch) => {
  ...
  it("can generate patch from blobs without 'old_blob'", function () {
    ...
    return NodeGit.Blob.lookup(this.repository, "b252f396b17661462372f78b7bcfc403b8731aaa").then((blob) => {
      return NodeGit.Patch.fromBlobs(null, file, blob, file).then((patch) => {
  ...
  it("can generate patch from blobs without arguments", function () {
    return NodeGit.Patch.fromBlobs().then((patch) => {
