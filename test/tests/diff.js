...
describe("Diff", function () {
  ...
  it("can diff the contents of a file to a string", function (done) {
    this.repository
      ...
      .then(function (blob) {
        var buffer = "New Text";
        return Diff.blobToBuffer(blob, null, buffer, null, null, null, null, function (delta, hunk, _payload) {
  ...
  it("can diff the contents of a file to a string with unicode characters", function (done) {
    ...
    Blob.createFromBuffer(test.repository, buffer, buffer.length)
      ...
      .then(function (blob) {
        ...
        return Diff.blobToBuffer(blob, null, evilString, null, null, null, null, function (_delta, _hunk, _payload) {
  ...
  describe("merge between commit diff and workdir and index diff", function () {
    ...
    it("can merge a diff from a commit into a diff from a work dir and index", function () {
      ...
      return Promise.all([getLinesFromDiff(test.workDirWithIndexDiff), getLinesFromDiff(test.commitDiff)])
