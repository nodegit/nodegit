  ...
  "targets": [
    {
      ...
      "sources": [
        ...
        "libgit2/src/libgit2/xdiff/xdiffi.c",
        "libgit2/src/libgit2/xdiff/xemit.c",
        "libgit2/src/libgit2/xdiff/xhistogram.c",
        "libgit2/src/libgit2/xdiff/xmerge.c",
        "libgit2/src/libgit2/xdiff/xpatience.c",
        "libgit2/src/libgit2/xdiff/xprepare.c",
        "libgit2/src/libgit2/xdiff/xutils.c",
      ...
      "conditions": [
        ...
        ["OS=='mac' or OS=='linux' or OS.endswith('bsd') or <(is_IBMi) == 1", {
          ...
          "sources": [
            ...
            "libgit2/src/libgit2/transports/auth_negotiate.c",
            "libgit2/src/libgit2/transports/auth_ntlm.c",
